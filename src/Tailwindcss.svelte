 ...
 */
  ...
  .chev {
    ...
    height: 0.5em;
    height: var(--chev-size, 0.5em);
    width: 0.5em;
    width: var(--chev-size, 0.5em);
    margin-top: calc(0.5em - 20%);
  ...
  .loading:after {
    ...
    -webkit-animation: spin var(--loading-speed, 0.5s) infinite linear;
    animation: spin 0.5s linear infinite;
    animation: spin var(--loading-speed, 0.5s) infinite linear;
  ...
  .content blockquote {
    ...
    --color-background: var(
      --color-neutral-normal-background,
      var(--color-fill)
    );
    --color-muted: var(--color-neutral-normal-muted);
    --color-title: var(
      --color-neutral-normal-title,
      var(--color-neutral-normal-content)
    );
    --color-core: var(--color-neutral);
  ...
  .supra {
    ...
    letter-spacing: var(--supra-letter-spacing, 0.06rem);
    color: #4a5568;
    color: var(--color-muted);
    font-size: 0.875rem;
  }
  ...
  .dropdown .dropdown-display {
    ...
    transition: opacity var(--dropdown-animation-speed, 0.1s);
    display: block;
    z-index: 10;
  }
  ...
  .field:hover {
    box-shadow: 0 0 1px 1px var(--color-light), 0 1px 3px 0 rgba(0, 0, 0, 0.1),
      0 1px 2px 0 rgba(0, 0, 0, 0.06);
    box-shadow: var(--field-hover-box-shadow, 0 0 1px 1px var(--color-light)),
      var(--fallback-box-shadow);
  }
  .field:focus {
    box-shadow: 0 0 0 2px var(--color-core), 0 1px 3px 0 rgba(0, 0, 0, 0.1),
      0 1px 2px 0 rgba(0, 0, 0, 0.06);
  ...
  .switch input[disabled] ~ * {
    opacity: 0.8;
    opacity: var(--switch-disabled-opacity, 0.8);
    cursor: not-allowed;
  }
  .textarea {
    border-color: #e2e8f0;
  ...
  .\~neutral.\!low {
    ...
    --color-muted: var(--color-neutral-low-muted);
    --color-title: var(
      --color-neutral-low-title,
      var(--color-neutral-low-content)
    );
  ...
  .\~neutral.\!high {
    ...
    --color-title: var(
      --color-neutral-high-title,
      var(--color-neutral-high-content)
    );
  ...
  .\~positive.\!low {
    ...
    --color-title: var(
      --color-positive-low-title,
      var(--color-positive-low-content)
    );
  ...
  .\~positive.\!high {
    ...
    --color-background: var(
      --color-positive-high-background,
      var(--color-fill)
    );
    --color-muted: var(--color-positive-high-muted);
    --color-title: var(
      --color-positive-high-title,
      var(--color-positive-high-content)
    );
  ...
  .\~warning {
    ...
    --color-background: var(
      --color-warning-normal-background,
      var(--color-fill)
    );
    --color-muted: var(--color-warning-normal-muted);
    --color-title: var(
      --color-warning-normal-title,
      var(--color-warning-normal-content)
    );
  ...
  .\~warning.\!low {
    ...
    --color-title: var(
      --color-warning-low-title,
      var(--color-warning-low-content)
    );
  ...
  .\~warning.\!high {
    ...
    --color-title: var(
      --color-warning-high-title,
      var(--color-warning-high-content)
    );
  ...
  .\~critical {
    ...
    --color-background: var(
      --color-critical-normal-background,
      var(--color-fill)
    );
    --color-muted: var(--color-critical-normal-muted);
    --color-title: var(
      --color-critical-normal-title,
      var(--color-critical-normal-content)
    );
  ...
  .\~critical.\!low {
    ...
    --color-title: var(
      --color-critical-low-title,
      var(--color-critical-low-content)
    );
  ...
  .\~critical.\!high {
    ...
    --color-background: var(
      --color-critical-high-background,
      var(--color-fill)
    );
    --color-muted: var(--color-critical-high-muted);
    --color-title: var(
      --color-critical-high-title,
      var(--color-critical-high-content)
    );
  ...
  .\~info {
    ...
    --color-title: var(
      --color-info-normal-title,
      var(--color-info-normal-content)
    );
  ...
  .\~urge {
    ...
    --color-title: var(
      --color-urge-normal-title,
      var(--color-urge-normal-content)
    );
